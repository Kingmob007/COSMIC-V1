...
module.exports = {
    ...
    SESSION: process.env.ASENA_CODE === undefined ? '' : process.env.ASENA_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    FAKE: process.env.FAKE_REMOVE === undefined ? 'false' : process.env.FAKE_REMOVE,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://www.linkpicture.com/q/COSMICV1.jpg' : process.env.GAN_IMAGE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+917025191792' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'ᴋʜᴀᴅʜᴇʀ' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By ᴄᴏꜱᴍɪᴄ ᴠ1' : process.env.ALL_CAPTION,
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '917025191792@s.whatsapp.net' : process.env.TAG_REPLY,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    PLKS: process.env.THERI_LIST === undefined ? false : process.env.THERI_LIST,
    AFPLK: process.env.COSMO_PASSWORD === undefined ? false : process.env.COSMO_PASSWORD,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴄᴏꜱᴍɪᴄ ᴠ1 ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    KAZTRO_SER: process.env.ALIVE_BUTTON === undefined ? 'KHADHER/COSMICV1' : process.env.ALIVE_BUTTON,   
    ...
    YAK: process.env.YAK === undefined ? '917025191792,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
